...
//    QTextCodec::setCodecForLocale(QTextCodec::codecForName("GBK"));
    ...
    this->setWindowTitle(QStringLiteral("坐标转换"));
...
void ProjectionSelector::initCRSTree()
{
    ...
    ui->lstCoordinateSystems->setHeaderLabels(QStringList() << QString::fromLocal8Bit("世界坐标系") << QString::fromLocal8Bit("地理坐标系") << "");
...
void ProjectionSelector::loadCrsList(QSet<QString> *crsFilter)
{
    ...
    mGeoList = new QTreeWidgetItem( ui->lstCoordinateSystems, QStringList( QString::fromUtf8( "鍦扮悊鍧愭爣绯荤粺" ) ) );
    ...
    mProjList = new QTreeWidgetItem( ui->lstCoordinateSystems, QStringList( QString::fromUtf8( "鎶曞奖鍧愭爣绯荤粺" ) ) );
